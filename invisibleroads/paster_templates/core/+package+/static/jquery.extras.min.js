...
if(typeof $.fn.dataTable!="undefined")$.fn.prepareTableOverlayForm=function(b,d){var a=b.prop("id"),c;return $(this).prepareOverlayForm().each(function(){var e=$(this),f=e.find("[name]"),g=e.find("[name=id]");g.length||(g=$("<input name=id type=hidden>").appendTo(e));var h=$("#"+a+"_add");h.length&&h.unbind().click(function(){f.not("[type=submit],[type=button]").val("");g.val("");e.trigger("showAdd").overlay().load()});(d||b.find("tr")).live({mouseenter:function(){var b=$(this).prop("id"),d=$("#"+
...
c,e,f,g;typeof a=="undefined"?(e=[],f=b.aoColumns,g=b.computeTableHeight):(c=a.$dataTable,c.fnClearTable(!1),e=c.fnSettings().aaSorting,f=a.aoColumns,g=a.computeTableHeight);c=d.dataTable({aaSorting:e,aoColumns:f,bDestroy:!0,bPaginate:!1,oLanguage:{sSearch:""},sScrollY:g()});a=d.prop("id");e="resize."+a;$(window).unbind(e).bind(e,function(){c.parents(".dataTables_scrollBody").height(g());c.fnAdjustColumnSizing()});d.data("dataTableCustom",{$dataTable:c,aoColumns:f,computeTableHeight:g});$("#"+a+"_filter input").prop("placeholder",
