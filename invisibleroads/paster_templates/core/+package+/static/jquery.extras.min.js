...
$.fn.clickToggle=function(a){function d(a){var c=a.find(".content");c.length&&a.html(c.html())}a=$.extend({},$.fn.clickToggle.defaults,a);return $(this).live({mouseenter:function(){var b=$(this),c=b.parents("tr");b.find(".content").length||b.html('<span class=content style="display:none">'+b.html()+"</span>");c.hasClass(a.requiredClass)?(c=c.hasClass(a.optionalClass)?a.offMessage:a.onMessage,b.append("<span class=flag>"+c+"</span>")):b.append('<span class="flag inactive">'+a.requiredMessage+"</span>");
$(this).css("cursor","pointer")},mouseleave:function(){var a=$(this);d(a);$(this).css("cursor","auto")},click:function(){var b=$(this),c=b.parents("tr");if(c.hasClass(a.requiredClass)){var e=c.hasClass(a.optionalClass),f=e?a.offMessage:a.onMessage;d(b);confirm(f+" "+c.find("."+a.nameClass).text()+"?")&&(f={token:token,id:getID(c[0])},f[a.postAttribute]=e?a.offValue:a.onValue,$.post(a.postURL,f,function(d){if(d.isOk){var e=c.parents("table");typeof d.content!="undefined"&&e.find("tbody").html(d.content);
typeof e.data("dataTableCustom")!="undefined"&&e.dataTableCustom();a.onSuccess.apply(b[0],[d])}else alert(d.message)}))}}})};$.fn.clickToggle.defaults={requiredClass:"",requiredMessage:"",optionalClass:"",onMessage:"",onValue:1,offMessage:"",offValue:0,postURL:"",postAttribute:"",nameClass:"",onSuccess:function(){}};
