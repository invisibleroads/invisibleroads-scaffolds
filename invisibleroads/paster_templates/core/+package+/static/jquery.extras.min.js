function getTipByName(a){var d={};a.each(function(){d[this.name]=this.title});return d}function setTipByName(a,d){var b=!1;a.each(function(){var c=this.name,a=d[c];a&&($(this).prop("title","<span class=error>"+a+"</span>").tooltip().show(),b||($("[name="+c+"]").focus().select(),b=!0))})}
$.fn.ajaxForm=function(a){var a=$.extend({},{onSubmit:function(){},onResponse:function(){}},a),d=$("[name=ajaxForm]");d.length||(d=$('<iframe name=ajaxForm style="display:none">').appendTo("body"));return $(this).each(function(){var b=$(this);b.prop("target","ajaxForm").prop("enctype","multipart/form-data").prop("encoding","multipart/form-data").submit(function(){a.onSubmit.apply(b[0]);if(!b.find("[type=file]").length)return $.post(b.prop("action"),b.serialize(),function(c){a.onResponse.apply(b[0],
[c])}),!1;d.one("load",function(){var c=d.contents().find("body").text(),e;try{e=eval("("+c+")")}catch(f){$.ajaxSettings.error(null,"parsererror")}a.onResponse.apply(b[0],[e])})})})};$.fn.focusNext=function(a){$(this).keydown(function(d){if(13==d.which)return a.focus(),!1})};
...
$.fn.clickToggle=function(a){function d(a){var c=a.find(".content");c.length&&a.html(c.html())}a=$.extend({},{requiredClass:"",requiredMessage:"",optionalClass:"",onMessage:"",onValue:1,offMessage:"",offValue:0,postURL:"",postAttribute:"",nameClass:"",onSuccess:function(){}},a);return $(this).live({mouseenter:function(){var b=$(this),c=b.parents("tr");b.find(".content").length||b.html('<span class=content style="display:none">'+b.html()+"</span>");b.find(".flag").length||(c.hasClass(a.requiredClass)?
(c=c.hasClass(a.optionalClass)?a.offMessage:a.onMessage,b.append("<span class=flag>"+c+"</span>")):b.append('<span class="flag inactive">'+a.requiredMessage+"</span>"));$(this).css("cursor","pointer")},mouseleave:function(){var a=$(this);d(a);$(this).css("cursor","auto")},click:function(){var b=$(this),c=b.parents("tr");if(c.hasClass(a.requiredClass)){var e=c.hasClass(a.optionalClass),f=e?a.offMessage:a.onMessage;d(b);confirm(f+" "+c.find("."+a.nameClass).text()+"?")&&(f={token:token,id:getID(c[0])},
f[a.postAttribute]=e?a.offValue:a.onValue,$.post(a.postURL,f,function(d){if(d.isOk){var e=c.parents("table");typeof d.content!="undefined"&&e.find("tbody").html(d.content);typeof e.data("dataTableCustom")!="undefined"&&e.dataTableCustom();a.onSuccess.apply(b[0],[d])}else alert(d.message)}))}}})};
