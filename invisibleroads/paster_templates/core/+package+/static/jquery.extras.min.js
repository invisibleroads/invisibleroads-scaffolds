function alertError(b){var c=b;if("object"==typeof b){var c=[],a;for(a in b)c.push(a+": "+b[a]);c=c.join("\n")}alert(c)}function getTipByName(b){var c={};b.each(function(){c[this.name||this.className]=this.title});return c}
function setTipByName(b,c){var a=!1;b.each(function(){var b=c[this.name||this.className];if(b){var e=$(this),f=e.tooltip(),b="<span class=error>"+b+"</span>";f.isShown()?f.getTip().html(b):e.prop("title",b);e.is(":visible")&&(e.tooltip().show(),a||(e.focus().select(),a=!0))}});return a}
